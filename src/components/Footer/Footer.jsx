    ...
    <Container id="footer">
      <Profile>
        ...
        <div className="address">
          ...
          <Slide direction="left">
            <p>116,Ayyanarappan koil ST,pandoor,gudavancheri,chengalpattu dist,603202</p>
          </Slide>
        </div>
        <div className="links">
          <Slide direction="left">
          ...
          <div>
            ...
            <Slide direction="left">
              <a href="tel:+4733378901">+91 6381556496</a>
            </Slide>
          </div>
          <div>
            <Slide direction="left">
            ...
            <Slide>
              <a href="mailto:miladamiri@gmail.com">yogeshvijay1912@gmail.com</a>
            </Slide>
          </div>
        </div>
